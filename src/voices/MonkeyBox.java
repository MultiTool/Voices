...
//    DC.gr.drawOval((int) (pnt.x - RadiusPixels), (int) (pnt.y - RadiusPixels), (int) DiameterPixels, (int) DiameterPixels);
  ...
  @Override public void ShallowLoad(JsonParse.Phrase phrase) {// ITextable
    ...
    this.TimeX = Double.parseDouble(IFactory.GetField(Fields, "TimeX", "0"));
    this.OctaveY = Double.parseDouble(IFactory.GetField(Fields, "OctaveY", "0"));
    this.LoudnessFactor = Double.parseDouble(IFactory.GetField(Fields, "LoudnessFactor", "1.0"));
    this.ScaleX = Double.parseDouble(IFactory.GetField(Fields, "ScaleX", "1.0"));
    this.ScaleY = Double.parseDouble(IFactory.GetField(Fields, "ScaleY", "1.0"));
    if (false) {
      this.OctavesPerRadius = Double.parseDouble(IFactory.GetField(Fields, "OctavesPerRadius", "0.01"));
      this.IsSelected = Boolean.parseBoolean(IFactory.GetField(Fields, "IsSelected", "false"));
    }
  }
  ...
  @Override public JsonParse.Phrase Export(CollisionTable CTable) {// ITextable
    ...
    HashMap<String, JsonParse.Phrase> Fields = phrase.ChildrenHash;
    Fields.put("TimeX", IFactory.PackField(this.TimeX));
    Fields.put("OctaveY", IFactory.PackField(this.OctaveY));
    Fields.put("LoudnessFactor", IFactory.PackField(this.LoudnessFactor));
    Fields.put("ScaleX", IFactory.PackField(this.ScaleX));
    Fields.put("ScaleY", IFactory.PackField(this.ScaleY));
    if (false) {
